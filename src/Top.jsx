...
function Field({ label, type = "text", name, value, onChange, multiline = false }) {
    ...
    <>
      ...
      >
        {glitching && !sent && (
          <motion.div
            ...
            style={{
              ...
              height: "30%",
              background: "linear-gradient(180deg, transparent 0%, rgba(220,38,38,0.08) 50%, transparent 100%)",
              pointerEvents: "none",
              zIndex: 0,
            }}
          />
        ...
        <div className={`glitch-wrap${glitching && !sent ? " active" : ""}`}>
          <span className="glitch-text" style={{ color: sent ? "rgba(220,38,38,0.6)" : "#fff", position: "relative", zIndex: 1 }}>
            {children}
          </span>
          <span className="glitch-before" data-text={children} aria-hidden="true">{children}</span>
          <span className="glitch-after" data-text={children} aria-hidden="true">{children}</span>
        </div>
      </motion.button>
    </>
  );
...
function LinkedInIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M7 10v7M7 7v.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/>
      <path d="M12 17v-4c0-1.657 1.343-3 3-3s3 1.343 3 3v4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
...
const socialLinks = [
  { icon: <GitHubIcon />,   label: "GitHub",   href: "https://github.com/usmanqaimkhani" },
  { icon: <LinkedInIcon />, label: "LinkedIn", href: "https://www.linkedin.com/in/usmanqaimkhani" },
  { icon: <EmailIcon />,    label: "Email",    href: "mailto:musmankhan671@gmail.com" },
];
            ...
            <div>
              ...
              <Reveal delay={0.2}>
                <p className="contact-desc">
                  Open to freelance collaborations, internship opportunities, and interesting engineering problems. If you have a project in mind — let's talk.
                </p>
              </Reveal>
              ...
              <Reveal delay={0.28}>
                <div>
                  {[
                    {
                      icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="currentColor" strokeWidth="1.5"/><polyline points="22,6 12,13 2,6" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/></svg>,
                      label: "Email",
                      value: "musmankhan671@gmail.com",
                    },
                    {
                      icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" stroke="currentColor" strokeWidth="1.5"/><circle cx="12" cy="10" r="3" stroke="currentColor" strokeWidth="1.5"/></svg>,
                      label: "Location",
                      value: "Karachi, Pakistan",
                    },
                    {
                      icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="18" rx="2" stroke="currentColor" strokeWidth="1.5"/><line x1="16" y1="2" x2="16" y2="6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><line x1="8" y1="2" x2="8" y2="6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><line x1="3" y1="10" x2="21" y2="10" stroke="currentColor" strokeWidth="1.5"/></svg>,
                      label: "Availability",
                ...
                <AnimatePresence mode="wait">
                  {sent ? (
                    ...
                    >
                      ...
                      <p style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: "1.2rem", color: "#fff" }}>
                        Message Sent
                      </p>
                      <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.72rem", color: "rgba(255,255,255,0.35)", lineHeight: 1.8 }}>
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => { e.target.style.borderColor = "rgba(220,38,38,0.3)"; e.target.style.color = "rgba(220,38,38,0.6)"; }}
